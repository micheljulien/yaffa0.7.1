...
/**  REVISION HISTORY:                                                       **/
/**                                                                          **/
/**    0.7.1 Michel Julien's contribution                                    **/
/**      - Fixed 'm*'                                                        **/
...
uint16_t base;  // stores the number conversion radix
...
void setup(void) {                
  ...
  Serial.println(F(" Dec."));
#endif
  Serial.print(F(" Max. Signed Integer: \t\t"));
...
//      if 'isNumber' finds a number, it is on the stack.        
      } else {
        push(-13);
        _throw();
        return;
